...
Route::group(['middleware' => 'auth:user'], function() {
    ...
    // FirstReport
    Route::get('firstreport', 'ReportController@showReports');
    Route::get('save-pdf', 'ReportController@savePdf');
    Route::get('report-mail-pdf', 'ReportController@getReportMailPdf');
    //Route::get('api/firstreport', ['as'=>'api.firstreport', 'uses'=>'FirstReportController@getDatatable']);
