...
<?php $__env->startSection('content'); ?>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title"><?php echo trans('texts.invoice_quote_number'); ?></h3>
        </div>
        <div class="panel-body form-padding-right">
            ...
            <div role="tabpanel">
                <ul class="nav nav-tabs" role="tablist" style="border: none">
                    ...
                    <li role="presentation">
                        <a href="#recurring_invoice_number" aria-controls="recurring_invoice_number" role="tab" data-toggle="tab"><?php echo e(trans('texts.recurring_invoice_number')); ?></a>
                    </li>
                </ul>
            </div>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body form-padding-right">
            ...
            <div role="tabpanel">
                <ul class="nav nav-tabs" role="tablist" style="border: none">
                    <li role="presentation" class="active">
                        <a href="#client_fields" aria-controls="client_fields" role="tab" data-toggle="tab"><?php echo e(trans('texts.client_fields')); ?></a>
                    </li>
                    <li role="presentation">
                        <a href="#company_fields" aria-controls="company_fields" role="tab" data-toggle="tab"><?php echo e(trans('texts.company_fields')); ?></a>
                    </li>
                    <li role="presentation">
                        <a href="#invoice_fields" aria-controls="invoice_fields" role="tab" data-toggle="tab"><?php echo e(trans('texts.invoice_fields')); ?></a>
                    </li>
                    <li role="presentation">
                        <a href="#invoice_item_fields" aria-controls="invoice_item_fields" role="tab" data-toggle="tab"><?php echo e(trans('texts.invoice_item_fields')); ?></a>
                    </li>
                    <li role="presentation">
                        <a href="#invoice_charges" aria-controls="invoice_charges" role="tab" data-toggle="tab"><?php echo e(trans('texts.invoice_charges')); ?></a>
                    </li>
                </ul>
            </div>
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="client_fields">
                    <div class="panel-body">
                        ...
                        <?php echo Former::text('custom_client_label1')
                                ->label(trans('texts.field_label')); ?>

                        <?php echo Former::text('custom_client_label2')
                                ->label(trans('texts.field_label'))
                ...
                <div role="tabpanel" class="tab-pane" id="company_fields">
                    <div class="panel-body">
                        ...
                        <?php echo Former::text('custom_label1')
                                ->label(trans('texts.field_label')); ?>
                        ...
                        <p>&nbsp;</p>
                        <?php echo Former::text('custom_label2')
                                ->label(trans('texts.field_label')); ?>
                ...
                <div role="tabpanel" class="tab-pane" id="invoice_fields">
                    <div class="panel-body">
                        ...
                        <?php echo Former::text('custom_invoice_text_label1')
                                ->label(trans('texts.field_label')); ?>

                        <?php echo Former::text('custom_invoice_text_label2')
                                ->label(trans('texts.field_label'))
                ...
                <div role="tabpanel" class="tab-pane" id="invoice_item_fields">
                    <div class="panel-body">
                        ...
                        <?php echo Former::text('custom_invoice_item_label1')
                                ->label(trans('texts.field_label')); ?>

                        <?php echo Former::text('custom_invoice_item_label2')
                                ->label(trans('texts.field_label'))
                ...
                <div role="tabpanel" class="tab-pane" id="invoice_charges">
                    <div class="panel-body">
                        ...
                        <?php echo Former::text('custom_invoice_label1')
                                ->label(trans('texts.field_label'))
                                ->addGroupClass('pad-checkbox')
                                ->append(Former::checkbox('custom_invoice_taxes1')
                                ->raw() . trans('texts.charge_taxes')); ?>

                        <?php echo Former::text('custom_invoice_label2')
                                ->label(trans('texts.field_label'))
                                ->addGroupClass('pad-checkbox')
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title"><?php echo trans('texts.quote_settings'); ?></h3>
        </div>
        <div class="panel-body form-padding-right">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><?php echo trans('texts.default_messages'); ?></h3>
      </div>
        <div class="panel-body form-padding-right">
        ...
        <div class="modal-dialog" style="min-width:150px">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <ul>
                        <?php foreach(\App\Models\Invoice::$patternFields as $field): ?>
                            <?php if($field == 'date:'): ?>
                    ...
                    <p><?php echo e(trans('texts.pattern_help_3', [
